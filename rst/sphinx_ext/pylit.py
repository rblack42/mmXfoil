...
class PylitLiteralIncludeReader:
...
class PylitLiteralInclude(SphinxDirective):
    """
    ...
    def run(self) -> list[Node]:
        ...
        try:
            ...
            reader = PylitLiteralIncludeReader(filename, self.options, self.config)
...
def setup(app: Sphinx) -> dict[str, Any]:
    directives.register_directive('pylitinclude', PylitLiteralInclude)
